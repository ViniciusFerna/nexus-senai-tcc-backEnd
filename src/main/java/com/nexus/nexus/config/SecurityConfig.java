	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(HttpMethod.GET, "/user/**", "/veiculos/**", 
						"/motoristas/**", "/rotas/**", "/pedido/**", "/cargas/**", "/simulacao/**").authenticated()
				.requestMatchers(HttpMethod.POST, "/veiculos/", "/motoristas/", "/rotas/", "/pedido/", "/cargas/", "/simulacao/").authenticated()
				.requestMatchers(HttpMethod.PUT, "/user/{id}", "/veiculos/{id}",
						"/motoristas/{id}", "/rotas/{id}", "/pedido/{id}", "/cargas/{id}", "/simulacao/{id}").authenticated()
